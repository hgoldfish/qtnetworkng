...
//DEFINEFUNC(int, MD4_Init, MD4_CTX *c, c, return 0, return)
//DEFINEFUNC3(int, MD4_Update, MD4_CTX *c, c, const void *data, data, unsigned long len, len, return 0, return)
//DEFINEFUNC2(int, MD4_Final, unsigned char *md, md, MD4_CTX *c, c, return 0, return)
//DEFINEFUNC(int, MD5_Init, MD5_CTX *c, c, return 0, return)
//DEFINEFUNC3(int, MD5_Update, MD5_CTX *c, c, const void *data, data, unsigned long len, len, return 0, return)
//DEFINEFUNC2(int, MD5_Final, unsigned char *md, md, MD5_CTX *c, c, return 0, return)
//DEFINEFUNC(int, SHA1_Init, SHA_CTX *c, c, return 0, return)
//DEFINEFUNC3(int, SHA1_Update, SHA_CTX *c, c, const void *data, data, unsigned long len, len, return 0, return)
//DEFINEFUNC2(int, SHA1_Final, unsigned char *md, md, SHA_CTX *c, c, return 0, return)
//DEFINEFUNC(int, SHA224_Init, SHA256_CTX *c, c, return 0, return)
//DEFINEFUNC3(int, SHA224_Update, SHA256_CTX *c, c, const void *data, data, unsigned long len, len, return 0, return)
//DEFINEFUNC2(int, SHA224_Final, unsigned char *md, md, SHA256_CTX *c, c, return 0, return)
//DEFINEFUNC(int, SHA256_Init, SHA256_CTX *c, c, return 0, return)
//DEFINEFUNC3(int, SHA256_Update, SHA256_CTX *c, c, const void *data, data, unsigned long len, len, return 0, return)
//DEFINEFUNC2(int, SHA256_Final, unsigned char *md, md, SHA256_CTX *c, c, return 0, return)
//DEFINEFUNC(int, SHA384_Init, SHA512_CTX *c, c, return 0, return)
//DEFINEFUNC3(int, SHA384_Update, SHA512_CTX *c, c, const void *data, data, unsigned long len, len, return 0, return)
//DEFINEFUNC2(int, SHA384_Final, unsigned char *md, md, SHA512_CTX *c, c, return 0, return)
//DEFINEFUNC(int, SHA512_Init, SHA512_CTX *c, c, return 0, return)
//DEFINEFUNC3(int, SHA512_Update, SHA512_CTX *c, c, const void *data, data, unsigned long len, len, return 0, return)
//DEFINEFUNC2(int, SHA512_Final, unsigned char *md, md, SHA512_CTX *c, c, return 0, return)

DEFINEFUNC(EVP_MD_CTX *, EVP_MD_CTX_new, void, DUMMYARG, return nullptr, return)
bool has_EVP_MD_CTX_new()
{
    return _q_EVP_MD_CTX_new != nullptr;
}

DEFINEFUNC(EVP_MD_CTX *, EVP_MD_CTX_create, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(void, EVP_MD_CTX_free, EVP_MD_CTX *c, c, return, DUMMYARG)
DEFINEFUNC(void, EVP_MD_CTX_cleanup, EVP_MD_CTX *c, c, return, DUMMYARG)
DEFINEFUNC3(int, EVP_DigestInit_ex, EVP_MD_CTX *c, c, const EVP_MD *t, t, ENGINE *impl, impl, return 0, return)
DEFINEFUNC3(int, EVP_DigestFinal_ex, EVP_MD_CTX *c, c, unsigned char *md, md, unsigned int *s, s, return 0, return)
DEFINEFUNC3(int, EVP_DigestUpdate, EVP_MD_CTX *c, c, const void *d, d, size_t cnt, cnt, return 0, return)
DEFINEFUNC(int, EVP_MD_block_size, const EVP_MD *md, md, return 0, return)
DEFINEFUNC(const EVP_MD *, EVP_MD_CTX_md, EVP_MD_CTX *c, c, return nullptr, return)
DEFINEFUNC(const EVP_MD *, EVP_md4, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_MD *, EVP_md5, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_MD *, EVP_sha1, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_MD *, EVP_sha224, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_MD *, EVP_sha256, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_MD *, EVP_sha384, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_MD *, EVP_sha512, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_MD *, EVP_ripemd160, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_MD *, EVP_blake2s256, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_MD *, EVP_blake2b512, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(void, OpenSSL_add_all_digests, void, DUMMYARG, return, DUMMYARG)

DEFINEFUNC(EVP_CIPHER_CTX *, EVP_CIPHER_CTX_new, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(void, EVP_CIPHER_CTX_free, EVP_CIPHER_CTX *c, c, return, DUMMYARG)
DEFINEFUNC6(int, EVP_CipherInit_ex, EVP_CIPHER_CTX *ctx, ctx, const EVP_CIPHER *type, type, ENGINE *impl, impl,
            unsigned char *key, key, unsigned char *iv, iv, int enc, enc, return 0, return)
DEFINEFUNC5(int, EVP_CipherUpdate, EVP_CIPHER_CTX *ctx, ctx, unsigned char *out, out, int *outl, outl, const unsigned char *in, in,
            int inl, inl, return 0, return)
DEFINEFUNC3(int, EVP_CipherFinal_ex, EVP_CIPHER_CTX *ctx, ctx, unsigned char *outm, outm, int *outl, outl, return 0, return)
DEFINEFUNC2(int, EVP_CIPHER_CTX_set_padding, EVP_CIPHER_CTX *c, c, int padding, padding, return 0, return)
DEFINEFUNC2(int, EVP_CIPHER_CTX_set_key_length, EVP_CIPHER_CTX *c, c, int keylen, keylen, return 0, return)
DEFINEFUNC4(int, EVP_CIPHER_CTX_ctrl, EVP_CIPHER_CTX *ctx, ctx, int type, type, int arg, arg, void *ptr, ptr, return 0, return)
DEFINEFUNC(int, EVP_CIPHER_nid, const EVP_CIPHER *e, e, return 0, return)
DEFINEFUNC(int, EVP_CIPHER_block_size, const EVP_CIPHER *e, e, return 0, return)
DEFINEFUNC(int, EVP_CIPHER_key_length, const EVP_CIPHER *e, e, return 0, return)
DEFINEFUNC(int, EVP_CIPHER_iv_length, const EVP_CIPHER *e, e, return 0, return)
DEFINEFUNC(unsigned long, EVP_CIPHER_flags, const EVP_CIPHER *e, e, return 0, return)
DEFINEFUNC(unsigned long, EVP_CIPHER_mode, const EVP_CIPHER *e, e, return 0, return)
DEFINEFUNC(int, EVP_CIPHER_type, const EVP_CIPHER *e, e, return 0, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_CIPHER_CTX_cipher, const EVP_CIPHER *e, e, return nullptr, return)
...
DEFINEFUNC8(int, PKCS5_PBKDF2_HMAC, const char *pass, pass, int passlen, passlen,
            ...
            return 0, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_enc_null, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_des_ecb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_des_cfb64, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_des_cfb1, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_des_cfb8, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_des_ofb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_des_cbc, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_des_ede, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_des_ede_ecb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_des_ede_cfb64, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_des_ede_ofb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_des_ede_cbc, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_des_ede3, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_des_ede3_ecb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_des_ede3_cfb64, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_des_ede3_cfb1, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_des_ede3_cfb8, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_des_ede3_ofb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_des_ede3_cbc, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_rc4, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_rc4_40, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_idea_ecb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_idea_cfb64, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_idea_ofb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_idea_cbc, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_rc2_ecb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_rc2_cbc, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_rc2_40_cbc, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_rc2_64_cbc, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_rc2_cfb64, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_rc2_ofb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_bf_ecb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_bf_cbc, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_bf_cfb64, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_bf_ofb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_cast5_ecb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_cast5_cbc, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_cast5_cfb64, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_cast5_ofb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_rc5_32_12_16_cbc, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_rc5_32_12_16_ecb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_rc5_32_12_16_cfb64, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_rc5_32_12_16_ofb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_128_ecb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_128_cbc, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_128_cfb1, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_128_cfb8, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_128_cfb128, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_128_ofb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_128_ctr, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_128_ccm, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_128_gcm, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_128_xts, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_128_wrap, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_192_ecb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_192_cbc, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_192_cfb1, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_192_cfb8, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_192_cfb128, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_192_ofb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_192_ctr, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_192_ccm, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_192_gcm, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_192_wrap, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_256_ecb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_256_cbc, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_256_cfb1, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_256_cfb8, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_256_cfb128, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_256_ofb, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_256_ctr, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_256_ccm, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_256_gcm, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_256_xts, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_aes_256_wrap, void, DUMMYARG, return nullptr, return)
DEFINEFUNC(const EVP_CIPHER *, EVP_chacha20, void, DUMMYARG, return nullptr, return)

DEFINEFUNC2(int, EVP_PKEY_set1_RSA, EVP_PKEY *a, a, RSA *b, b, return 0, return)
DEFINEFUNC2(int, EVP_PKEY_set1_DSA, EVP_PKEY *a, a, DSA *b, b, return 0, return)
DEFINEFUNC2(int, EVP_PKEY_set1_EC_KEY, EVP_PKEY *a, a, EC_KEY *b, b, return 0, return)
...
DEFINEFUNC2(int, EVP_PKEY_set_type, EVP_PKEY *a, a, int b, b, return 0, return)
DEFINEFUNC(int, EVP_PKEY_base_id, const EVP_PKEY *a, a, return 0, return)
DEFINEFUNC(int, EVP_PKEY_bits, EVP_PKEY *a, a, return 0, return)
DEFINEFUNC(int, EVP_PKEY_size, EVP_PKEY *a, a, return 0, return)
DEFINEFUNC2(int, EVP_PKEY_cmp, const EVP_PKEY *a, a, const EVP_PKEY *b, b, return 0, return)
DEFINEFUNC4(int, EVP_SignFinal, EVP_MD_CTX *a, a, unsigned char *b, b, unsigned int *c, c, EVP_PKEY *d, d, return 0, return)
DEFINEFUNC4(int, EVP_VerifyFinal, EVP_MD_CTX *a, a, unsigned char *b, b, unsigned int *c, c, EVP_PKEY *d, d, return 0, return)
...
DEFINEFUNC3(int, EVP_DigestSignFinal, EVP_MD_CTX *a, a, unsigned char *b, b, size_t *c, c, return 0, return)
DEFINEFUNC5(int, EVP_DigestVerifyInit, EVP_MD_CTX *a, a, EVP_PKEY_CTX **b, b, const EVP_MD *c, c, ENGINE *d, d, EVP_PKEY *e, e, return 0, return)
DEFINEFUNC3(int, EVP_DigestVerifyFinal, EVP_MD_CTX *a, a, const unsigned char *b, b, size_t c, c, return 0, return)
DEFINEFUNC2(EVP_PKEY_CTX *, EVP_PKEY_CTX_new, EVP_PKEY *a, a, ENGINE *b, b, return nullptr, return)
DEFINEFUNC2(EVP_PKEY_CTX *, EVP_PKEY_CTX_new_id, int *a, a, ENGINE *b, b, return nullptr, return)
DEFINEFUNC(EVP_PKEY_CTX *, EVP_PKEY_CTX_dup, EVP_PKEY_CTX *a, a, return nullptr, return)
DEFINEFUNC(void, EVP_PKEY_CTX_free, EVP_PKEY_CTX *a, a, return, DUMMYARG)
DEFINEFUNC2(int, EVP_PKEY_CTX_set_signature_md, EVP_PKEY_CTX *a, a, const EVP_MD *b, b, return 0, return)
DEFINEFUNC(int, EVP_PKEY_sign_init,  EVP_PKEY_CTX *a, a, return 0, return)
DEFINEFUNC5(int, EVP_PKEY_sign, EVP_PKEY_CTX *a, a, unsigned char *b, b, size_t *c, c, const unsigned char *d, d, size_t e, e, return 0, return)
DEFINEFUNC(int, EVP_PKEY_verify_init,  EVP_PKEY_CTX *a, a, return 0, return)
DEFINEFUNC5(int, EVP_PKEY_verify, EVP_PKEY_CTX *a, a, const unsigned char *b, b, size_t c, c, const unsigned char *d, d, size_t e, e, return 0, return)
DEFINEFUNC(int, EVP_PKEY_encrypt_init, EVP_PKEY_CTX *a, a, return 0, return)
DEFINEFUNC5(int, EVP_PKEY_encrypt, EVP_PKEY_CTX *a, a, unsigned char *b, b, size_t *c, c, const unsigned char *d, d, size_t e, e, return 0, return)
DEFINEFUNC(int, EVP_PKEY_decrypt_init, EVP_PKEY_CTX *a, a, return 0, return)
DEFINEFUNC5(int, EVP_PKEY_decrypt, EVP_PKEY_CTX *a, a, unsigned char *b, b, size_t *c, c, const unsigned char *d, d, size_t e, e, return 0, return)
DEFINEFUNC(int, EVP_PKEY_keygen_init, EVP_PKEY_CTX *a, a, return 0, return)
DEFINEFUNC2(int, EVP_PKEY_keygen, EVP_PKEY_CTX *a, a, EVP_PKEY **b, b, return 0, return)
DEFINEFUNC(int, EVP_PKEY_derive_init, EVP_PKEY_CTX *a, a, return 0, return)
DEFINEFUNC2(int, EVP_PKEY_derive_set_peer, EVP_PKEY_CTX *a, a, EVP_PKEY *b, b, return 0, return)
DEFINEFUNC3(int, EVP_PKEY_derive, EVP_PKEY_CTX *a, a, unsigned char *b, b, size_t *c, c, return 0, return)

DEFINEFUNC(RSA *, RSA_new, DUMMYARG, DUMMYARG, return nullptr, return)
DEFINEFUNC(void, RSA_free, RSA *a, a, return, DUMMYARG)
DEFINEFUNC(int, RSA_size, const RSA *a, a, return 0, return)
DEFINEFUNC4(int, RSA_generate_key_ex, RSA *a, a, int b, b, BIGNUM *c, c, BN_GENCB *d, d, return 0, return)
DEFINEFUNC5(int, RSA_private_encrypt, int a, a, const unsigned char *b, b, unsigned char *c, c, RSA *d, d, int e, e, return 0, return)
DEFINEFUNC5(int, RSA_public_decrypt, int a, a, const unsigned char *b, b, unsigned char *c, c, RSA *d, d, int e, e, return 0, return)
DEFINEFUNC5(int, RSA_public_encrypt, int a, a, const unsigned char *b, b, unsigned char *c, c, RSA *d, d, int e, e, return 0, return)
DEFINEFUNC5(int, RSA_private_decrypt, int a, a, const unsigned char *b, b, unsigned char *c, c, RSA *d, d, int e, e, return 0, return)
...
DEFINEFUNC(X509 *, X509_new, DUMMYARG, DUMMYARG, return nullptr, return)
DEFINEFUNC2(int, X509_cmp, X509 *a, a, X509 *b, b, return -1, return)
DEFINEFUNC(long, X509_get_version, const X509 *x, x, return -1, return)
DEFINEFUNC2(int, X509_set_version, X509 *x, x, long v, v, return 0, return)
...
DEFINEFUNC2(int, X509_verify, X509 *a, a, EVP_PKEY *b, b, return 0, return)
DEFINEFUNC3(int, X509_REQ_sign, X509_REQ *a, a, EVP_PKEY *b, b, const EVP_MD *c, c, return 0, return)
DEFINEFUNC2(int, X509_REQ_verify, X509_REQ *a, a, EVP_PKEY *b, b, return 0, return)
...
DEFINEFUNC2(int, X509_set_notBefore, X509 *a, a, const ASN1_TIME *b, b, return 0, return)
DEFINEFUNC2(int, X509_set_notAfter, X509 *a, a, const ASN1_TIME *b, b, return 0, return)
DEFINEFUNC(ASN1_TIME *, X509_getm_notBefore, const X509 *a, a, return nullptr, return)
DEFINEFUNC(ASN1_TIME *, X509_getm_notAfter, const X509 *a, a, return nullptr, return)
...
DEFINEFUNC4(X509 *, PEM_read_bio_X509, BIO *a, a, X509 **b, b, pem_password_cb *c, c, void *d, d, return nullptr, return)
...
DEFINEFUNC2(int, PEM_write_bio_X509, BIO *a, a, X509 *b, b, return 0, return)
DEFINEFUNC2(int, PEM_write_bio_X509_REQ, BIO *a, a, X509_REQ *b, b, return 0, return)
DEFINEFUNC2(int, PEM_write_bio_X509_REQ_NEW, BIO *a, a, X509_REQ *b, b, return 0, return)
DEFINEFUNC2(int, PEM_write_bio_X509_CRL, BIO *a, a, X509_CRL *b, b, return 0, return)
DEFINEFUNC2(int, PEM_write_bio_PKCS7, BIO *a, a, PKCS7 *b, b, return 0, return)

DEFINEFUNC(BIGNUM *, BN_new, DUMMYARG, DUMMYARG, return nullptr, return)
DEFINEFUNC2(int, BN_set_word, BIGNUM *a, a, BN_ULONG b, b, return 0, return)
...
DEFINEFUNC2(int, ASN1_INTEGER_set, ASN1_INTEGER *a, a, long b, b, return -1, return)
DEFINEFUNC(unsigned char *, ASN1_STRING_data, ASN1_STRING *a, a, return nullptr, return)
DEFINEFUNC(int, ASN1_STRING_length, ASN1_STRING *a, a, return 0, return)
DEFINEFUNC2(int, ASN1_STRING_to_UTF8, unsigned char **a, a, ASN1_STRING *b, b, return 0, return)
DEFINEFUNC2(int, ASN1_TIME_set_string, ASN1_TIME *a, a, const char *b, b, return 0, return)
DEFINEFUNC(ASN1_TIME *, ASN1_TIME_new, DUMMYARG, DUMMYARG, return nullptr, return)
...
DEFINEFUNC2(BIO *, BIO_new_mem_buf, const void *a, a, int b, b, return nullptr, return)
DEFINEFUNC(BIO_METHOD *, BIO_s_mem, void, DUMMYARG, return nullptr, return)
DEFINEFUNC3(int, BIO_read, BIO *a, a, void *b, b, int c, c, return -1, return)
DEFINEFUNC3(int, BIO_write, BIO *a, a, const void *b, b, int c, c, return -1, return)
DEFINEFUNC(int, BIO_up_ref, BIO *a, a, return -1, return)
...
DEFINEFUNC2(int, RAND_bytes, unsigned char *buf, buf, int num, num, return 0, return)
...
DEFINEFUNC2(void *, sk_value, const STACK *a, a, int b, b, return nullptr, return)
...
DEFINEFUNC(const char *, SSL_CIPHER_get_name, const SSL_CIPHER *a, a, return nullptr, return)
...
//DEFINEFUNC2(long, SSL_CTX_set_options, SSL_CTX *a, a, long b, b, return -1, return)
...
DEFINEFUNC(X509 *, SSL_get_certificate, const SSL *a, a, return nullptr, return)

DEFINEFUNC(long, SSL_get_verify_result, const SSL *a, a, return -1, return)
DEFINEFUNC(int, SSL_get_verify_mode, const SSL *a, a, return -1, return)
...
DEFINEFUNC2(void, SSL_set0_rbio, SSL *a, a, BIO *b, b, return, DUMMYARG)
DEFINEFUNC(BIO *, SSL_get_rbio, SSL *a, a, return nullptr, return)
DEFINEFUNC2(void, SSL_set0_wbio, SSL *a, a, BIO *b, b, return, DUMMYARG)
DEFINEFUNC(BIO *, SSL_get_wbio, SSL *a, a, return nullptr;, return)
...
static int dlIterateCallback(struct dl_phdr_info *info, size_t size, void *data)
{
    if (size < sizeof (info->dlpi_addr) + sizeof (info->dlpi_name))
        return 1;
    QSet<QString> *paths = reinterpret_cast<QSet<QString> *>(data);
...
const QStringList &qAsConst(QStringList &t) { return t; }
...
static QAtomicInt triedToResolveSymbols;
static QAtomicInt symbolsResolved;

bool q_resolveOpenSslSymbols(bool force)
{
    if(symbolsResolved.load() > 0) {
        return true;
    }
    int tried = triedToResolveSymbols.fetchAndAddAcquire(1);
    if(!force && tried > 0) {
        return false;
    }
    ...
    if (!libs.first || !libs.second)
        // failed to load them
        return false;
    qDebug() << libs.first->fileName() << libs.second->fileName();

    // here we defined.
//    RESOLVEFUNC(MD4_Init)
//    RESOLVEFUNC(MD4_Update)
//    RESOLVEFUNC(MD4_Final)
//    RESOLVEFUNC(MD5_Init)
//    RESOLVEFUNC(MD5_Update)
//    RESOLVEFUNC(MD5_Final)
//    RESOLVEFUNC(SHA1_Init)
//    RESOLVEFUNC(SHA1_Update)
//    RESOLVEFUNC(SHA1_Final)
//    RESOLVEFUNC(SHA224_Init)
//    RESOLVEFUNC(SHA224_Update)
//    RESOLVEFUNC(SHA224_Final)
//    RESOLVEFUNC(SHA256_Init)
//    RESOLVEFUNC(SHA256_Update)
//    RESOLVEFUNC(SHA256_Final)
//    RESOLVEFUNC(SHA384_Init)
//    RESOLVEFUNC(SHA384_Update)
//    RESOLVEFUNC(SHA384_Final)
//    RESOLVEFUNC(SHA512_Init)
//    RESOLVEFUNC(SHA512_Update)
//    RESOLVEFUNC(SHA512_Final)

    RESOLVEFUNC(EVP_MD_CTX_new)
    RESOLVEFUNC(EVP_MD_CTX_create)
    RESOLVEFUNC(EVP_MD_CTX_free)
    RESOLVEFUNC(EVP_MD_CTX_cleanup)
    RESOLVEFUNC(EVP_DigestInit_ex)
    RESOLVEFUNC(EVP_DigestFinal_ex)
    RESOLVEFUNC(EVP_DigestUpdate)
    RESOLVEFUNC(EVP_MD_block_size)
    RESOLVEFUNC(EVP_md4)
    RESOLVEFUNC(EVP_md5)
    ...
    RESOLVEFUNC(EVP_blake2s256)
    RESOLVEFUNC(EVP_blake2b512)
    RESOLVEFUNC(OpenSSL_add_all_digests)
    ...
    RESOLVEFUNC(EVP_CIPHER_nid)
    RESOLVEFUNC(EVP_CIPHER_block_size)
    RESOLVEFUNC(EVP_CIPHER_key_length)
    RESOLVEFUNC(EVP_CIPHER_iv_length)
    RESOLVEFUNC(EVP_CIPHER_flags)
    RESOLVEFUNC(EVP_CIPHER_mode)
    ...
    RESOLVEFUNC(EVP_aes_256_wrap)
    RESOLVEFUNC(EVP_chacha20)
    ...
    RESOLVEFUNC(EVP_PKEY_free)
    RESOLVEFUNC(EVP_PKEY_size)
    RESOLVEFUNC(EVP_PKEY_cmp)
    RESOLVEFUNC(EVP_SignFinal)
    RESOLVEFUNC(EVP_VerifyFinal)
    RESOLVEFUNC(EVP_DigestSignInit)
    RESOLVEFUNC(EVP_DigestSignFinal)
    RESOLVEFUNC(EVP_DigestVerifyInit)
    RESOLVEFUNC(EVP_DigestVerifyFinal)
    RESOLVEFUNC(EVP_PKEY_CTX_new)
    RESOLVEFUNC(EVP_PKEY_CTX_new_id)
    RESOLVEFUNC(EVP_PKEY_CTX_dup)
    RESOLVEFUNC(EVP_PKEY_CTX_free)
    RESOLVEFUNC(EVP_PKEY_CTX_set_signature_md)
    RESOLVEFUNC(EVP_PKEY_sign_init)
    RESOLVEFUNC(EVP_PKEY_sign)
    RESOLVEFUNC(EVP_PKEY_verify_init)
    RESOLVEFUNC(EVP_PKEY_verify)
    RESOLVEFUNC(EVP_PKEY_encrypt_init)
    RESOLVEFUNC(EVP_PKEY_decrypt_init)
    RESOLVEFUNC(EVP_PKEY_encrypt)
    RESOLVEFUNC(EVP_PKEY_decrypt)
    ...
    RESOLVEFUNC(EVP_PKEY_bits)
    RESOLVEFUNC(EVP_PKEY_size)
    RESOLVEFUNC(BN_new)
    RESOLVEFUNC(BN_free)
    RESOLVEFUNC(BN_set_word)
    RESOLVEFUNC(RSA_generate_key_ex)
    RESOLVEFUNC(RSA_private_encrypt)
    RESOLVEFUNC(RSA_public_decrypt)
    ...
    RESOLVEFUNC(PEM_write_bio_PKCS7)
    ...
    RESOLVEFUNC(ASN1_TIME_new)
    RESOLVEFUNC(ASN1_STRING_free)
    RESOLVEFUNC(ASN1_TIME_set_string)
    ...
    RESOLVEFUNC(SSL_CIPHER_get_name)
...
//    RESOLVEFUNC(SSL_CTX_set_options)
    ...
    RESOLVEFUNC(SSL_get_certificate)
    RESOLVEFUNC(SSL_get_verify_result)
    RESOLVEFUNC(SSL_get_verify_mode)
    ...
    RESOLVEFUNC(SSL_set0_rbio)
    RESOLVEFUNC(SSL_get_rbio)
    RESOLVEFUNC(SSL_set0_wbio)
    RESOLVEFUNC(SSL_get_wbio)
    ...
    RESOLVEFUNC(X509_verify)
    RESOLVEFUNC(X509_REQ_sign)
    RESOLVEFUNC(X509_REQ_verify)
    ...
    symbolsResolved.fetchAndAddAcquire(1);
    delete libs.first;
    delete libs.second;
    return true;
}
