...
#ifndef QTNG_SYSTEMLIBRARY_P_H
#define QTNG_SYSTEMLIBRARY_P_H
...
public:
    ...
    {
        m_handle = load(reinterpret_cast<const wchar_t *>(m_libraryName.utf16()), onlySystemDirectory);
        m_didLoad = true;
        return m_handle;
    }
