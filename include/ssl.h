...
public:
    ...
    bool setPrivateKey(const QString &fileName, Ssl::EncodingFormat format = Ssl::Pem,
...
public:
    ...
    static SslConfiguration testPurpose(const QString &commonName, const QString &countryCode,
...
inline QSharedPointer<SocketLike> asSocketLike(SslSocket *s)
{
    return asSocketLike(QSharedPointer<SslSocket>(s));
}
